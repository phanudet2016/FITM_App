              ...
              <View style={styles.projectRow}>
                <View style={{width: Dimensions.get('window').width - 50, flexDirection: 'row',alignItems: 'center'}}>
                  <TouchableOpacity 
                    ...
                    onPress = {() => 
                      {
                        this.props.navigation.navigate('ListScore', {score: rowData.score, nameSubject: rowData.nameSubject, BGcolor: rowData.backgroundColor})
                      }
                    }
                  >
                    <Text style={{color: '#fff',fontSize: 18}}>{(rowData.nameSubject.toUpperCase()).substring(0, 1)}</Text>
                  </TouchableOpacity> 
                  <Text style={styles.itemName} onPress = {() => { this.props.navigation.navigate('ListScore', {score: rowData.score, nameSubject: rowData.nameSubject, BGcolor: rowData.backgroundColor})}}>
                      {rowData.nameSubject}
                  </Text>
                </View>
